...
<i id="menu-chart_widget2" class="material-icons md-18 sm-icon" title="Options">more_vert</i>
</div>
</div>

<div id="loaderDiv2" class="loaderDiv"></div>
<div id="chart_widget2" class="chart_daily_trend jsdn_chart"></div>
...
$(document).ready(function () {
	$('#menu-chart_widget2').materialMenu('init', {
		position: 'overlay',
		identifier:'chart_widget2',
		items: [	
			{
				type: 'label',

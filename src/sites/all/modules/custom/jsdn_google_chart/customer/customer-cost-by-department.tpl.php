<div class="filter-dropdown">
    <div id="filter_spend_provider_div2" class="filter-dropdown">
        <div class="widgetDotMenu">
            <i id="menu-chart_widget30" class="material-icons md-18 sm-icon" title="Options">more_vert</i>
        </div>
    </div>
</div>
<div id="loaderDiv30" class="loaderDiv"></div>
<div id="chart_widget30" class="chart_daily_trend jsdn_chart"></div>
<script>
(function( $ ) {
    ...
    $(document).ready(function () {
	$('#menu-chart_widget30').materialMenu('init', {
		position: 'overlay',
		identifier:'chart_widget30',
		items: [
                        {
                            type: 'label',

...
<i id="menu-chart_widget19" class="material-icons md-18 sm-icon" title="Options">more_vert</i>
</div>
</div>
<div id="filter_chart_widget19" class="filter-dropdown"></div>
...
(function( $ ) {
    ...
    $(document).ready(function () {
	$('#menu-chart_widget19').materialMenu('init', {
		position: 'overlay',
		identifier:'chart_widget19',
		items: [	
			{
                            type: 'label',

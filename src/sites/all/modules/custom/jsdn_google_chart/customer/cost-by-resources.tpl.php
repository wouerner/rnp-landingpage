...
<i id="menu-chart_widget15" class="material-icons md-18 sm-icon" title="Options">more_vert</i>
</div>
</div>
<div id="loaderDiv15" class="loaderDiv"></div>
<div id="chart_widget15" class="chart_daily_trend jsdn_chart"></div>
...
(function( $ ) {
    ...
    $(document).ready(function () {
	$('#menu-chart_widget15').materialMenu('init', {
		position: 'overlay',
		identifier:'chart_widget15',
		items: [	
			{
                            type: 'label',
